...
\abstract{An Electron-Ion Collider (EIC) is the next big scientific facility to be built in the United States, costing over \$1 billion in design and construction. The necessity for excellent hadronic particle identification around the electron/ion beam interaction point, namely in the barrel region, has pushed R\&D towards a Detection of Internally Reflected Cherenkov light (DIRC) detector design. In order to reach the desired performance of $3\sigma$ $\pi/K$ separation at 6 GeV/c particle momentum a new 3-layer spherical lens focusing optic was designed and tested in a prototype DIRC detector with a hadron-rich particle beam at the CERN PS. Measurements of the focal plane of the lens as well as radiation hardness of the lanthanum crown glass of the center layer were tested on test benches at Old Dominion University and the Catholic University of America. Results for these tests are presented here.}
...
\input{chapters/introduction} % intro, eic, etc
%
\chapter{Electron-Ion Collider}
\input{chapters/eic} % description of EIC and why it's needed
%
\chapter{DIRC Technology}
\input{chapters/dirc} % explination of DIRC technology
%
\chapter{High-Performance DIRC@EIC}
\input{chapters/eicdirc} % specifications of high-performance DIRC@EIC
%
%\chapter{Test Bench Evaluation of DIRC@EIC Components}
\chapter{Testing DIRC Components}
\input{chapters/components} % testing lens focal plane and rad hardness, and MCP-PMTs
%
\chapter{3-Layer Lens Performance in Particle Beam}
\input{chapters/analysis} % analysis results from CERN 2015 test beam
%
\chapter{Outlook and Summary}
\input{chapters/summary} % outlook of future work and summary of results
...
\achapter{Signal Reconstruction Fitting}
