...
\begin{figure}[ht]
	...
	\caption{Current design of the EIC facility for JLab with the two interaction points highlighted in red (top), and the current baseline design for the detector at IP1 (bottom).}
...
The large center of mass energies and diverse physics program at an EIC necessitate a very sophisticated detector system. Figure \ref{fig:jleic_layout} (bottom) shows the current design of the JLab EIC detector at IP1. 
